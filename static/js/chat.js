...
async function sendMessage() {
  ...
  loading.className = "loading"; loading.innerText = "⏳...";
  chat.appendChild(loading); scrollToBottom();
  ...
  try {
    ...
    loading.remove(); appendMessage("⚠️ Error: " + err.message, "bot");
  }
}
...
async function showCalendar() {
  try {
    ...
    chat.appendChild(cal); scrollToBottom();
  } catch (err) {
...
function buildCalendar(slots) {
  ...
  function render(offset) {
    ...
    table.appendChild(tbody); cal.appendChild(table);
  }
...
function addPayButton(bookingId) {
  ...
  chat.appendChild(payBtn); scrollToBottom();
}
